...
atam1912 = wish(id=1, student_id=1, wish_date=datetime.date(2019, 12, 19), nickname='@nechla', wish_performer='Zemfira', wish_melody=2,wish_genre=6)
kovt1912 = wish(id=2, student_id=4, wish_date=datetime.date(2019, 12, 19), nickname='@kovla', wish_performer='', wish_melody=3,wish_genre=1)
paly1812 = wish(id=3, student_id=5, wish_date=datetime.date(2019, 12, 18), nickname='@pasha', wish_performer='', wish_melody=2,wish_genre=6)
kube1612 = wish(id=4, student_id=7, wish_date=datetime.date(2019, 12, 16), nickname='@bubomash', wish_performer='', wish_melody=2,wish_genre=6)
