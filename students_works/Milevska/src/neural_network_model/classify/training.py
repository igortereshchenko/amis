...
import nltk
import time
from neural_network_model.classify.ext import LancasterStemmer
from neural_network_model.load_dataset import training_data
...
class TrainingModel:
    def __init__(self, is_train=False):
        if is_train:
            result = self.preprocessed_data(training_data())
    ...
    def preprocessed_data(self, training_data):
...
def start_train():
    ...
    train_model.train(x, y, hidden_neurons=20, alpha=1.0, epochs=50000, dropout=False, dropout_percent=0.2)
