...
file_path = os.path.join(app.root_path, 'neural_network_model', 'data/simple.json')
...
for item in data:
    i += 1
    training_data.append({"class": item['discipline'], "sentence":item['question']})
    if i > 600:
        break
...
# print ()
classify("what can I take if I just started being allergic to cats?")